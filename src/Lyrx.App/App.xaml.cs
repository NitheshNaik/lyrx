...
using Lyrx.App.Tray;
using Lyrx.Core.Caching;
using Lyrx.Core.Color;
using Lyrx.Core.Lyrics;
using Lyrx.Core.Media;
using Lyrx.Core.Power;
using Lyrx.Core.Settings;
using Lyrx.ViewModels;

namespace Lyrx.App;

/// <summary>
/// Lyrx Application Host.
...
public partial class App : Application
{
    ...
    private void SetupGlobalExceptionLogging()
    {
        UnhandledException += (sender, e) =>
        {
            try
            {
                ...
                string logDir = Path.Combine(appData, "Lyrx", "logs");
    ...
    private void ConfigureServices()
    {
        ...
        services.AddHttpClient<ILyricProvider, LrcLibProvider>(client =>
        {
            ...
            client.DefaultRequestHeaders.Add("User-Agent", "Lyrx/1.0 (https://github.com/lyrx)");
    ...
    protected override void OnLaunched(LaunchActivatedEventArgs args)
    {
        ...
        _singleInstanceMutex = new Mutex(true, "Lyrx_SingleInstance_Mutex_9A1F", out bool createdNew);
        if (!createdNew)
        {
            Debug.WriteLine("[App] Another instance of Lyrx is already running. Exiting.");
            Environment.Exit(0);
            return;
        }
